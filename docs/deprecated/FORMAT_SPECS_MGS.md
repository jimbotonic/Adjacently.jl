...
> **DEPRECATED**: This document describes the legacy MGS V1 format and is kept for historical reference only. For the current format specification, see [`FORMAT_SPECS_MGS_v2.md`](FORMAT_SPECS_MGS_v2.md).
