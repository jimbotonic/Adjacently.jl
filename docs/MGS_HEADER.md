...
|-------|-----------|-------|------------|
| 0x10–0x4F | BG + params | 64 | 6 |
| 0x50–0x6F | CS + params | 32 | 5 |
| 0x70–0xFF | CG + params | 144 | ~7 |

#### BG Parameter Encoding (6 bits, offset = byte2 − 0x10)
...
#### CG Parameter Encoding — v3.2 (mixed-radix, offset = byte2 − 0x70, max 143)
...
In index mode, BG forces `stop_deltas=false` and `empty_prefix=false` (redundant with
