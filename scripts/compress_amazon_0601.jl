...
#
# Load Amazon_0601 core & rcore, predict CGE params with trained GNN,
# grid-search for best params, further train GNN, save best .mgz files.
#
# Usage:
#   julia --project scripts/compress_amazon_0601.jl
#
...
const DS_DIR = joinpath(PROJECT_ROOT, "datasets", "Amazon_0601")
const CORE_MGS = joinpath(DS_DIR, "Amazon_0601_core.mgs")
const RCORE_MGS = joinpath(DS_DIR, "Amazon_0601_rcore.mgs")
...
function main()
    fp("=" ^ 72)
    fp("  Amazon_0601 CGE Compression Pipeline")
    fp("=" ^ 72)

    # =====================================================================
    # 1. Load graphs
    # =====================================================================
    fp("\n[1/7] Loading Amazon_0601 core and rcore from .mgs files...")
    ...
    # =====================================================================
    fp("\n[6/7] Further training GNN with Amazon_0601 subgraphs...")
    ...
    for (label, g, best_tuple, ne_g) in [
        ...
        base = joinpath(DS_DIR, "Amazon_0601_$(label)_cge_k$(K)")
        mgz_file = base * ".mgz"
    ...
    for (label, g, best_tuple, ne_g) in [
        ...
        config_name, bpe, params, clusters, K = best_tuple
        mgz_file = joinpath(DS_DIR, "Amazon_0601_$(label)_cge_k$(K).mgz")
