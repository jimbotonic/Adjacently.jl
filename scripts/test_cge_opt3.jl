...
#
# Benchmark three new CGE optimizations on top of implicit-ranges baseline (2.666 BPE):
...
println("=" ^ 70)
println("CGE Optimization Benchmark (baseline: 2.666 BPE implicit ranges)")
println("=" ^ 70)
