...
#
# Save CNR-2000 compressed with best known RCGE parameters.
# Best known: 2.4341 BPE (3-way adaptive copy, w=64, zigzag, stop-deltas, adaptive adds/raw)
#
# Output: datasets/webgraph/cnr-2000/cnr2000_rcge_best.rcge
#
...
println("=" ^ 70)
println("RCGE Best-Params Save: CNR-2000")
println("=" ^ 70)
println("Parameters:")
...
out_path = normpath(joinpath(@__DIR__, "..", "datasets", "webgraph", "cnr-2000", "cnr2000_rcge_best.rcge"))
