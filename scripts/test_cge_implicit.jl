...
#
# Fair comparison: CGE FW64 K=1 with EF vs implicit_ranges membership
#
...
println("=" ^ 70)
println("CGE FW64 K=1: EF vs Implicit Membership (fair comparison)")
println("=" ^ 70)
...
# Save implicit file
out_path = normpath(joinpath(@__DIR__, "..", "datasets", "webgraph", "cnr-2000", "cnr2000_cge_gllp_implicit.cge"))
...
println("")
println("  Reference: CGE FW64 K=1 (saved file):  2.887 BPE  (1160561 bytes)")
println("=" ^ 70)
